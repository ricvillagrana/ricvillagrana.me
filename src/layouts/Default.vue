  ...
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="border-t-14 border-gray-900">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <div>
          <g-link v-if="theme === 'theme-light'" to="/" class="no-underline text-2xl border-none text-gray-900 hover:text-gray-800">Ricardo Villagrana</g-link>
          <g-link v-else to="/" class="no-underline text-2xl border-none text-white">Ricardo Villagrana</g-link>
        </div>
        ...
        >
          <li class="mr-8 mb-6 lg:mb-0 w-full md:w-auto">
            <search-input />
          </li>
          ...
          <li class="mr-8 mb-6 lg:mb-0">
            <a v-if="$route.path === '/'" href="/#experience" v-scroll-to="'#experience'" class="text-copy-primary hover:text-gray-600">Experience</a>
            <g-link v-else to="/#experience" class="text-copy-primary hover:text-gray-600">Experience</g-link>
          </li>
          <li class="mr-8 mb-6 lg:mb-0">
    ...
    <footer class="bg-gray-900 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center">
          <li class="mr-8">
            <a href="mailto:contact@ricvillagrana.me" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://github.com/ricvillagrana" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://twitter.com/ricvillagrana" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://instagram.com/ricvillagrana" target="_blank" class="text-white hover:text-gray-400">
